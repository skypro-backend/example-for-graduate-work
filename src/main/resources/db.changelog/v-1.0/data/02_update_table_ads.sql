...
INSERT INTO ads(
    id   , author_id ,image, price,  title )
VALUES
    (1,12,null,13545,'Несмотря на то, что это недорогой гаджет, Redmi Note 12 оснащен 120-герцовой 6,67-дюймовой OLED-панелью с разрешением Full HD+.' ||
    ...
    (2,5,null,21999,'Электросамокат Xiaomi Mi Electric Scooter Essential станет вашим надежным спутником в путешествии по улицам города. Модель отличается' ||
    ...
    (3,25,null,4580,'Мультиварка Galaxy GL2645 выполнена в черно-серебристой расцветке из металла и пластика. Главным достоинством представленной 5-литровой ' ||
