...
alter table comments add constraint fk_ads foreign key (ads_id) references ads(ads_id);

--changeset ShilovaNatalia:comments_add_fk_to_user
alter table comments add constraint fk_ads_user_profiles foreign key (user_profile_id) references user(user_profile_id);
...
--changeset ShilovaNatalia:ads_add_image
